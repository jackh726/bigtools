...
def bedgraphtobigwig(comp):
    ...
    benchmarks = {
        ...
        'bigtools_1thread_multipass_serial_inmemory':            [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF518WII.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--inmemory']],
        'bigtools_1thread_multipass_serial_nozooms':             [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF518WII.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--nzooms', '0']],
        'bigtools_1thread_multipass_serial_nozooms_inmemory':    [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF518WII.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--nzooms', '0', '--inmemory']],
        ...
        'bigtools_1thread_singlepass_serial_inmemory':           [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF518WII.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--single-pass']],
        'bigtools_1thread_singlepass_serial_nozooms':            [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF518WII.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--single-pass']],
        'bigtools_1thread_singlepass_serial_nozooms_inmemory':   [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF518WII.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--single-pass']],
    ...
    benchmarks = {
        ...
        'bigtools_1thread_multipass_serial_inmemory':            [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF841DHZ.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--inmemory']],
        'bigtools_1thread_multipass_serial_nozooms':             [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF841DHZ.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--nzooms', '0']],
        'bigtools_1thread_multipass_serial_nozooms_inmemory':    [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF841DHZ.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--nzooms', '0', '--inmemory']],
        ...
        'bigtools_1thread_singlepass_serial_inmemory':           [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF841DHZ.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--single-pass', '--inmemory']],
        'bigtools_1thread_singlepass_serial_nozooms':            [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF841DHZ.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--single-pass', '--nzooms', '0']],
        'bigtools_1thread_singlepass_serial_nozooms_inmemory':   [['{}/bedgraphtobigwig'.format(bigtoolspath),  './workdir/ENCFF841DHZ.bedGraph', './workdir/hg38.chrom.sizes', './workdir/test_out_bigtools.bigWig', '-t 1', '-p no', '--single-pass', '--nzooms', '0', '--inmemory']],
